...
def remove_attach():
	...
	if "System Manager" not in roles or frappe.session.user == "Administrator":
		frappe.throw(_('COMUNIQUESE CON SOPORTE PARA REALIZAR ESTA ACCIÓN'))
	"""remove attachment"""
...
def validate_link():
	...
	if frappe.session.user == '47694368@shalomcontrol.com':
