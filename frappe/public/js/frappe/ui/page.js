...
frappe.ui.Page = Class.extend({
	...
	make_new : function() {
		...
		setTimeout(()=>{
			...
			window.cur_list.page.add_menu_item(__("Video Tutorial"), async function() {

				const tutoriales = await frappe.db.get_list("Videos Tutoriales",{
					"filters":[["parent","=",cur_list.doctype]],
					"fields":["titulo","enlace"],
					"limit":"None"
				})

				if (tutoriales.length == 0){
					frappe.throw("No hay ningun video tutorial para este apartado")
				}
				let html = `<div class="form-grid">
							<div class="grid-heading-row">
							<div class="grid-row">
							<div class="data-row row">
							<div class="col grid-static-col col-xs-7 " title="Titulo">
							<div class="field-area" style="display: none;"></div>
							<div class="static-area ellipsis">Titulo</div>
							</div>
							<div class="col grid-static-col col-xs-5 " title="Enlace">
							<div class="field-area" style="display: none;"></div>
							<div class="static-area ellipsis">Enlace</div>
							</div>
							</div>
							</div>
							</div>
							<div class="grid-body">
							<div class="rows">
							<div class="grid-row" data-name="row 1" data-idx="1">
							<div class="data-row row">`
				for (const tutorial of tutoriales) {
					html += `<div class="col grid-static-col col-xs-7 " data-fieldname="titulo" data-fieldtype="Data">
							<div class="field-area" style="display: none;"></div>
							<div class="static-area ellipsis">${tutorial.titulo}</div>
							</div>
							<div class="col col-xs-5 " data-fieldname="enlace" data-fieldtype="Data">
							<div class="field-area" style="display: none;"></div>
							<div class=" ellipsis"><a href="${tutorial.enlace}" class="btn btn-default ellipsis" target="_blank">Ver tutorial</a></div>
							</div>`
				}
				html += `</div>
						</div>
				...
				dialog.show();
				// window.open(tutoriales[0].enlace,"_blank")
	...
	setup_page: function() {
		...
		// if(window.location.pathname == "/app/salary-slip"){
		// 	$(".dropdown-menu").append(`
		// 		<li id="li-test">
		// 			<a class="grey-link dropdown-item" id="btnGenerateTxts" >
		//
		// 				<span class="menu-item-label" data-label="Generar Txts"><span class="alt-underline">G</span>enerar Txts</span>
		// 			</a>
		// 		</li>
		//
		// 	`)
		// }else if(window.location.pathname == "/app/solicitud-de-pagos"){
		// 	$(".dropdown-menu").append(`
		// 		<li id="li-test">
		// 			<a class="grey-link dropdown-item" id="btnGenerateExcel" >
		//
		// 				<span class="menu-item-label" data-label="Costo Agencias"><span class="alt-underline">C</span>osto de Agencias</span>
		// 			</a>
		// 		</li>
		//
		// 	`)
