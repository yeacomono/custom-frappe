...
frappe.ui.form.PrintView = class {
	...
	render_page(method, printit = false) {
		...
		console.log(method, printit)

		if(this.frm.doc.doctype.trim() == "Contrato de Trabajo".trim() && method == "/api/method/frappe.utils.print_format.download_pdf?"){

			frappe.throw("La función de imprimir PDF no está disponible. Intente imprimir desde el botón azul Impresión")
